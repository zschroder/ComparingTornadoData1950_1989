...
ModernBigDays.sfdfT %>%
  ...
  head(10)
```
There is a 70% match in the top 10 big days between the modern and historical records. The historical record has 3 days which do not fall within the top 10 in the modern record. However, they are found in the top 20 of the modern record. These include: 
...
Apr3 <- HistBigDays.sfdfT %>%
  filter(cDate == "1974-04-03", groupNumber == 84)
...
Apr3 <- ModernBigDays.sfdfT %>%
  filter(cDate == "1974-04-03", groupNumber == 1477)
